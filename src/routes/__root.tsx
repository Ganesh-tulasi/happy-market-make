...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Ziffy — Make Every Gift Personal" },
      { property: "og:description", content: "Hand-crafted chocolates, bouquets, mugs & combos with same-day delivery." },
